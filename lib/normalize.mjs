 ...
 *
 *   Monday   integrity   api-inspector  DIGESTS  ids D_*
 *   Friday   asset       api-inspector  DIGESTS  ids AI_*
 *   Sunday   leadership  ascend         BRIEFS   ids B_*
 */
...
export const STREAMS = {
  integrity: { label: 'Integrity Coaching', day: 'Monday', accent: 'teal' },
  asset: { label: 'Asset Integrity', day: 'Friday', accent: 'orange' },
  leadership: { label: 'Leadership', day: 'Sunday', accent: 'blue' },
};
